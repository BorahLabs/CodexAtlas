        ...
        <div class="flex flex-col justify-center items-center w-full z-20">
            ...
            <div class="flex flex-col justify-start w-full z-20">
                <div class="p-[2px] mb-2 flex justify-center items-center bg-input-gradient rounded-xl w-full relative">
                    <textarea wire:model="description" type="text"
                        class="bg-dark resize-none rounded-xl w-full h-full text-white placeholder-gray-700" rows="6"
            ...
            @if ($concept)
                <div class="group transition duration-300 z-20 self-end">
                    <button type="button"
                        wire:click="$dispatch('openModal', { component: 'glossary.delete-confirmation-modal', arguments: { concept: '{{ $concept->id }}' }})"
                        class="group text-right mt-2 text-white flex items-center z-20 ">
                        <x-icons.trash class="w-4 h-4" />
                        <span class="ml-2">
                            Delete concept
                        </span>
            ...
            <div class="mt-10 flex flex-col text-white gap-2 z-20 w-full lg:flex-row">
                <button type="button" wire:click="saveAndCreateAnother"
                    ...
                    <div class="bg-gradient-to-b from-[#6042ff] to-transparent p-px rounded-xl w-full flex">
                        <div class="bg-black py-4 px-6 rounded-xl text-white w-full flex justify-center items-center">
                            ...
                            <span class="sm:ml-2 text-sm sm:text-base">SAVE AND ADD ANOTHER</span>
                        </div>
                    </div>
                </button>
