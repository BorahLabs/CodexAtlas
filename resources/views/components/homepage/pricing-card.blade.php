@props(['imageUrl', 'price', 'title', 'description', 'included' => [], 'notIncluded' => [], 'cta', 'ctaUrl', 'asForm' => false])
        ...
        <div class="relative p-10">
            ...
            <div class="relative">
                ...
                <div>
                    ...
                    @if ($asForm)
                        <form action="{{ $ctaUrl }}" method="POST">
                            @csrf
                            <button type="submit" class="group inline-flex w-full md:w-auto h-14 px-7 items-center justify-center text-base font-medium text-black hover:text-white bg-violet-500 hover:bg-black transition duration-200 rounded-full">
