...
@php
    $style = match ($theme) {
        ...
        'primary'
            => 'inline-flex items-center px-4 py-3 bg-violet-600 border border-transparent rounded-xl font-semibold text-xs text-white uppercase tracking-widest hover:bg-white focus:bg-violet-700 active:bg-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-offset-violet-700 transition ease-in-out duration-150',
    };
@endphp
@isset($href)
