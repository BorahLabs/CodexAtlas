<div class="relative table mb-12 mx-auto">
    <span class="absolute w-full text-center top-[12px] text-sm font-bold">
        #1 Code Docs Tool
    </span>
    <span class="flex justify-center absolute top-[29px] w-full">
