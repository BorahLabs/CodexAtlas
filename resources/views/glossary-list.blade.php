            ...
            <div class="mt-16">
                <div class="flex justify-between items-center mb-16">
                    ...
                    <button type="button"
                        ...
                        x-on:click="Livewire.dispatch('openModal', { component: 'add-project-concept', arguments: { project: '{{$project->id}}' }})">
                        ...
                        <span class="uppercase text-base">Add Keyword content</span>
                    </button>
                </div>
