    ...
    <div x-data="{ showBlur: false }" @open.window="showBlur=true" @close.window="showBlur=false">
        ...
        <div>
            <header class="flex items-center justify-between">
                <h1 class="text-white title-gradient text-4xl font-bold">Glossary</h1>
            </header>

            <div class="mt-10">
                <p class="text-white">
                    While artificial intelligence can be great at understanding your code in many ways, there are
                    still
                    areas that need human expertise and knowledge. Could you work with us to address these needs?
                    If your project involves specific terms or concepts, please feel free to provide them so that we
                    can
                    customise our documentation and provide you with the best possible service.
                </p>

                @if (auth()->user()->currentTeam->subscriptionType()->canUseGlossary())
                    <div class="mt-16">
